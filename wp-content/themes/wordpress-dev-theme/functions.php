...
function wordpress_dev_theme_the_post_header() {
  ...
  <div class="entry-header">
    <div class="entry-meta">
      <?php echo get_avatar( get_the_author_meta( 'ID' ) , 45 ); ?><span class="author-name"><?php _e('From:', 'wordpress_dev_theme'); ?> <strong><a href="<?php echo get_author_posts_url( get_the_author_meta( 'ID' ), get_the_author_meta( 'user_nicename' ) ); ?>"><?php the_author(); ?></a></strong></span>
...
function wordpress_dev_theme_script_enqueue() {
  ...
  wp_register_style( 'bootstrap', get_stylesheet_directory_uri() . '/bootstrap/css/bootstrap.min.css', array(), '3.3.6');
  wp_register_script('bootstrap-script', get_template_directory_uri() . '/bootstrap/js/bootstrap.min.js', array('jquery'), '3.3.6', false);
